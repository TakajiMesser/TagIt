...
namespace TagIt.WPF.Helpers
{
    public static class FilePathHelper
    {
        ...
        public static string TEMPORARY_THUMBNAIL_DIRECTORY = @"C:\Users\Takaji\source\repos\TagIt.WPF\TagIt.WPF\ThumbnailLibraries\Temp";

        public static string INITIAL_LOCAL_DIRECTORY = @"C:\Users\Takaji\Documents";
